...
void MapInit()
{
	...
	g_ClassicMode.SetItemMappings( @SC_TOYSOLDIERS::g_Ins2ItemMappings );
	g_ClassicMode.ForceItemRemap( true );

	g_Hooks.RegisterHook( Hooks::PickupObject::Materialize, @SC_TOYSOLDIERS::PickupObjectMaterialize );
}