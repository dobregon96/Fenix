...
class CMonsterrace : ScriptBaseMonsterEntity
{
	...
	void Precache()
	{
		...
		g_SoundSystem.PrecacheSound("portalhouse/race/race_alert1.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_alert2.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_idle2.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_idle3.wav");
		
		g_SoundSystem.PrecacheSound("portalhouse/race/race_die1.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_die2.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_pain5.wav");

		g_SoundSystem.PrecacheSound("portalhouse/race/race_pain1.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_pain2.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_pain3.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_pain4.wav");
		
		g_SoundSystem.PrecacheSound("portalhouse/race/race_idle3.wav");
		g_SoundSystem.PrecacheSound("portalhouse/race/race_idle4.wav");
	...
	{
		if( self.IsPlayerAlly() )
			g_EntityFuncs.SetModel( self, "models/portalhouse/race.mdl" );
		else
			g_EntityFuncs.SetModel( self, "models/portalhouse/race.mdl" );
	}
	...
	void FearScream()
	{
		if( m_flNextFearScream < g_Engine.time )
		{
			...
			{
			case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_alert1.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: break;
			case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_alert2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: break;
			case 4: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_idle2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 5: break;
			case 6: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_idle3.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
			case 7: break;
			}
	...
	void PainSound()
	{
		...
		{
		case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_pain1.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_pain2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_pain3.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 3: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_pain4.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		}
	}
	...
	void DeathSound()
	{
		...
		{
		case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_die1.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_die2.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_pain5.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		}
	}
	...
	void VictorySound()
	{
		switch (Math.RandomLong(0,3))
		{
		case 0: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_idle3.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: break;
		case 2: g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_idle4.wav", 1, ATTN_NORM, 0, PITCH_NORM); break;
		case 3: break;
		}
	}
	...
	void FollowerUse( CBaseEntity@ pActivator, CBaseEntity@ pCaller, USE_TYPE useType, float flValue )
	{
		...
		{
			g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_idle4.wav", 1, ATTN_NORM, 0, PITCH_NORM);
		}
		else
			g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "portalhouse/race/race_idle2.wav", 1, ATTN_NORM, 0, PITCH_NORM);
	}
}
