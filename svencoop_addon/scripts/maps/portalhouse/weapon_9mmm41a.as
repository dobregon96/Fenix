...
class weapon_9mmm41a : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_SoundSystem.PrecacheSound( "portal_house/weapons/m41a_single.wav" );
		g_SoundSystem.PrecacheSound( "portal_house/weapons/m41a_single.wav.wav" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/v_9mmm41a.mdl" ), self.GetP_Model( "models/portal_house/p_m16a2.mdl" ), MP5_DEPLOY, "mp5" );
	}
...
void RegisterHLMP5()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_9mmm41a", GetHLMP5Name() );
	g_ItemRegistry.RegisterWeapon( GetHLMP5Name(), "portal_house", "9mm", "ARgrenades" );
}
