...
class weapon_vulcan : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/bshift_skin/v_768mmvulcan.mdl" );
	...
	bool Deploy()
	{
		...
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/bshift_skin/v_768mmvulcan.mdl" ), self.GetP_Model( HREPEATER_MODEL_NULL ), HREPEATER_DRAW, "bow" );
	}
...
void RegisterHREPEATER()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_vulcan", "portalhouse", "flechette" );
}
