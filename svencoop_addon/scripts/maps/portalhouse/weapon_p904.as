...
class weapon_p904 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/portal_house/bshift_skin/v_p904.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/portal_house/bshift_skin/v_p904.mdl" ), self.GetP_Model( "models/portal_house/p_p904.mdl" ), MP5_DEPLOY, "mp5" );
	}
...
void RegisterHLMP5()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_p904", GetHLMP5Name() );
